...
<div class="col-lg-8">
    <div class="card">
        <div class="card-header"><strong>Edit</strong><small> brand</small></div>
        ...
        <form action="{{route('update-brand')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body card-block">
                <input name="brand_id" value="{{$brand->id}}" type="hidden" class="form-control" id="exampleFormControlInput1">
                {{-- brand Name --}}
                <div class="form-group">
                    <label for="brand_name" class=" form-control-label">brand Name</label>
                    <input type="text" id="brand_name" value="{{$brand->brand_name}}" name="brand_name" placeholder="Enter brand name" class="form-control">
                </div>
                {{-- brand_description --}}
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-12">
                        <textarea name="brand_description" value="{{$brand->brand_description}}" id="brand_description" rows="4" placeholder="" class="form-control"></textarea>
                    </div>
                </div>
                {{-- brand Image --}}
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-12">
                        <input type="file" id="file-input" value="{{$brand->brand_image}}" name="brand_image" class="form-control-file">
                        <img src="{{ asset($brand->brand_image) }}" alt="" width="60px" height="50px" >
                    </div>
                </div>
                {{-- Publication Status --}}
                <div class="row form-group">
