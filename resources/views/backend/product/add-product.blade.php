        ...
        <form action="{{route('new-product')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body card-block">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="product_code" name="product_code" placeholder="Enter product code" class="form-control">
                    @error('product_code')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="product_price" name="product_price" placeholder="Enter product price" class="form-control">
                    @error('product_price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="product_quantitye" name="product_quantity" placeholder="Enter product quantity" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="product_short_description" name="product_short_description" onblur="getproductName()" placeholder="write short description" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-12">
                        <textarea name="product_long_description" id="product_long_description" rows="4" placeholder="" class="form-control"></textarea>
                ...
                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">Add product</button>
            </div>
        </form>
    </div>
</div>
{{-- <script>
    function getproductName(){
        ...
        $.ajax({
            url: "get-product-name/"+product_name,
            method: "GET",
            dataType: "JSON",
